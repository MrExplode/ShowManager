...
dependencies {
    ...
    implementation(group = "io.javalin",               name = "javalin",                 version = "7.1.0")
    ...
    implementation(group = "redis.clients",            name = "jedis",                   version = "7.3.0")
    ...
    mockitoAgent(      group = "org.mockito",       name = "mockito-core",          version = "5.21.0") {
        isTransitive = false
    }
}
