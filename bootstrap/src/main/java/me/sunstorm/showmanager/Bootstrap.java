    ...
    public static void main(String... args) {
        ...
        if (optionSet.has("debug") || optionSet.has("withRAM")) {
            EventQueue.invokeLater(() -> {
                try {
                    Class<?> clazz = Class.forName("me.sunstorm.showmanager.gui.ServerGUI");
...
//            }
    ...
    private static void showVersionError(String currentVer) {
        ...
        JOptionPane.showConfirmDialog(null, ep, "ShowManager", JOptionPane.OK_CANCEL_OPTION, JOptionPane.ERROR_MESSAGE, null);
    }
